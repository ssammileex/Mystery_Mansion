function init() {
	...
	locale[3] = new locales("Location 3", "Living Room", "There is a huge fireplace. The house is ice cold. Find matches and wood to start a fire.", "Matches");
	locale[4] = new locales("Location 4", "Hallway", "There is a painting hanging on the wall. The painting strikes you as odd and out of place. Behind it you find a safe that requires a passcode.", "Photograph");
	locale[5] = new locales("Location 5", "Bedroom", "The hallway led to a single bedroom. It consists of a bed and a nightstand. On the nightstand there is a leather journal containing a passcode.", "Journal");
	...
	locale[7] = new locales("Location 7", "Courtyard", "The house has a huge courtyard completely surrounded by trees, and a porch coming off the back of the house. Next to the porch is a pile of wood, that you should take. Also, in the furthest west corner of the property you see what looks to be a small shed.", "Wood");
	locale[8] = new locales("Location 8", "Shed", "In the shed is another ghost. She is the wife of the ghost in the house.", "none");
